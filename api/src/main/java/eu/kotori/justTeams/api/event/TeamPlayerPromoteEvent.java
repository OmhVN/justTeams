...
public class TeamPlayerPromoteEvent extends TeamEvent implements Cancellable {
    ...
    public TeamPlayerPromoteEvent(ITeam team, UUID playerUuid, TeamRole oldRole, TeamRole newRole) {
        super(team);
