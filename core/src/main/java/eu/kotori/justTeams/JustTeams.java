...
import eu.kotori.justTeams.api.JustTeamsAPI;
import eu.kotori.justTeams.api.JustTeamsProvider;
...
import eu.kotori.justTeams.core.quests.QuestListener;
import eu.kotori.justTeams.core.quests.QuestManager;
import eu.kotori.justTeams.core.redis.RedisManager;
...
import eu.kotori.justTeams.core.storage.StorageManager;
import eu.kotori.justTeams.core.team.GlowManager;
import eu.kotori.justTeams.core.team.TeamManager;
import eu.kotori.justTeams.core.team.TeamUpgradeManager;
import eu.kotori.justTeams.core.util.AliasManager;
import eu.kotori.justTeams.core.util.BedrockSupport;
import eu.kotori.justTeams.core.util.ChatInputManager;
import eu.kotori.justTeams.core.util.CommandManager;
import eu.kotori.justTeams.core.util.ConfigUpdater;
import eu.kotori.justTeams.core.util.DataRecoveryManager;
import eu.kotori.justTeams.core.util.DebugLogger;
import eu.kotori.justTeams.core.util.DiscordWebhookManager;
import eu.kotori.justTeams.core.util.FeatureRestrictionManager;
import eu.kotori.justTeams.core.util.GuiConfigManager;
import eu.kotori.justTeams.core.util.PAPIExpansion;
import eu.kotori.justTeams.core.util.StartupManager;
import eu.kotori.justTeams.core.util.StartupMessage;
import eu.kotori.justTeams.core.util.TaskRunner;
import eu.kotori.justTeams.core.util.VersionChecker;
import eu.kotori.justTeams.core.util.WebhookHelper;
...
public final class JustTeams extends JavaPlugin implements JustTeamsAPI {
   ...
   public void onEnable() {
      instance = this; JustTeamsProvider.register(this);
   ...
   public void onDisable() {
      Logger logger = this.getLogger();
      JustTeamsProvider.unregister(); logger.info("Disabling JustTeams...");
